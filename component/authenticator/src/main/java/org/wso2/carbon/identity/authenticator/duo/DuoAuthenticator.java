...
public class DuoAuthenticator extends AbstractApplicationAuthenticator implements FederatedApplicationAuthenticator {
    ...
    protected void initiateAuthenticationRequest(HttpServletRequest request, HttpServletResponse response,
        ...
        if (authenticatedUser != null) {
            ...
            if (!isDisableUserStoreDomainInUserName(authenticatorProperties)) {
                username = addDomainToName(username, authenticatedUser.getUserStoreDomain());
            }
        }
    ...
    public static String addDomainToName(String name, String domainName) {
        ...
        if (domainName != null && name != null && !name.contains(DuoAuthenticatorConstants.DOMAIN_SEPARATOR)) {
            name = domainName + DuoAuthenticatorConstants.DOMAIN_SEPARATOR + name;
        }
        return name;
    }
